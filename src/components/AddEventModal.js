...
const AddEventModal = ({ show, onClose, onAddEvent, onSave, minDate }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <optgroup label="Cycling Events">
                <option value="Road Race">Road Race</option>
                <option value="Time Trial">Time Trial</option>
                <option value="Gran Fondo">Gran Fondo</option>
                <option value="Mountain Bike Race">Mountain Bike Race</option>
                <option value="Cyclocross">Cyclocross</option>
              </optgroup>
              <optgroup label="Swimming Events">
                <option value="Open Water Swim">Open Water Swim</option>
                <option value="Pool Competition">Pool Competition</option>
              </optgroup>
              <optgroup label="Triathlon Events">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
              placeholder="e.g., 42.2km, 100 miles, 1.5k swim"
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
              rows="3" 
              placeholder="Special considerations, goals, nutrition strategy, etc." 
            />
          </div>
...
AddEventModal.propTypes = {
  ...
  onAddEvent: PropTypes.func, // Support both callback names
  onSave: PropTypes.func,     // Support both callback names
